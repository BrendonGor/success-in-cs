...
I got my freshman spring internship and sophmore summer internship at the career fair. I've also gotten multiple interviews and offers from the career fair. To put into perspective, I wen't to the CS and Engineering career fairs and got ~4 offers after ~6 interviews. After applying to over 100 positions online I got 2 interviews and 1 offer.
I know KSoC students with similar experiences. Online job postings get hundreds of applications. 
</Collapse>
2. Use job aggregator websites like https://github.com/SimplifyJobs or specialized job boards like https://www.workatastartup.com/internships
3. Apply online through Handshake, LinkedIn, etc. For sites like this you will need to apply to as many as you can to get a response.
4. There are countless other ways to get a job.
:::note
If applying online, use an extension like https://simplify.jobs/copilot to automate filling out applications.
:::
